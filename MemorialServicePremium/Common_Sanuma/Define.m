...
//Localizeファイル名
NSString *const LOCALIZE_FILE = @"fixedSentenceSanuma";
...
/* 葬儀社情報 */
NSString *const MORTICIAN_NAME    = @"株式会社佐沼葬儀社";
NSString *const MORTICIAN_POST    = @"987-0511";
NSString *const MORTICIAN_ADDRESS = @"登米市迫町佐沼字中江1-13-1";
NSString *const MORTICIAN_TEL     = @"0220-22-7790";
NSString *const MORTICIAN_URL     = @"http://e-sousai.com/";

/*タクシー会社_メールアドレス*/
NSString * const TAXI_MAIL_ADDRESS = @"yamayamato8@gmail.com";   //テスト用

/*店舗情報_地図*/
NSString * const MAP_PIN_TITLE  = @"佐沼葬儀社";                         //テスト用

/* 法要アプリWeb-API URL */
NSString *const SAVE_DEVICE_TOKEN  = @"http://ms-sanuma.memorial-site.net/Cooperation/saveiosdevicetoken";
NSString *const SAVE_DEVICE_TOKEN_AND_DECEASED_ID = @"http://ms-sanuma.memorial-site.net/Cooperation/saveiosdevicetokenanddeceasedid";
NSString *const GET_NOTICE_INFO    = @"http://ms-sanuma.memorial-site.net/Cooperation/getnoticeinfo";
NSString *const VIEW_NOTICE_INFO   = @"http://ms-sanuma.memorial-site.net/mng/viewnoticeinfo";
NSString *const GET_NOTICE_INFO_TOKEN = @"http://ms-sanuma.memorial-site.net/Cooperation/getnoticeinfoanddeceasedid";
NSString *const READ_TRANSFER_DATA = @"http://ms-sanuma.memorial-site.net/Cooperation/readtranseferdata";
NSString *const DOWNLOAD_PHOTO     = @"http://ms-sanuma.memorial-site.net/cooperation/downloadphoto";
NSString *const SEND_DATA_KEY_MAIL = @"http://ms-sanuma.memorial-site.net/Cooperation/senddatakeymailios";
NSString *const GET_NOTICE_INFO_DELIVERED = @"http://ms-sanuma.memorial-site.net/cooperation/getnoticeinfodelivered";
NSString *const GET_NOTICE_INFO_DELIVERED_TOKEN = @"http://ms-sanuma.memorial-site.net/cooperation/getnoticeinfodeliveredbytoken";
NSString *const SEND_MEMORIAL_MAIL = @"http://ms-sanuma.memorial-site.net/Cooperation/sendmemorialmailios";
NSString *const SAVE_TRANSFER_DATA = @"http://ms-sanuma.memorial-site.net/cooperation/savetransferdata";
NSString *const UP_PHOTO = @"http://ms-sanuma.memorial-site.net/cooperation/upphoto";
NSString *const SYUKATSU = @"http://ms-sanuma.memorial-site.net/Cooperation/syukatsuios";
NSString *const READ_DECEASED_DATA = @"http://ms-sanuma.memorial-site.net/cooperation/readdeceaseddata";
