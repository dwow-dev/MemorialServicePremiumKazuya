...
- (void)viewDidLoad
{
    ...
    float height = [[UIScreen mainScreen]bounds].size.height+550;
    ...
    // URLボタン背景色変更
    UIColor *color = [UIColor colorWithRed:TOOLBAR_BG_COLOR_RED green:TOOLBAR_BG_COLOR_GREEN blue:TOOLBAR_BG_COLOR_BLUE alpha:0.85];
    self.morticianUrlButton.backgroundColor = color;
...
- (IBAction)pushUrl:(id)sender {
    NSString *urlString = @"http://www.flora-g.co.jp/funeral";
