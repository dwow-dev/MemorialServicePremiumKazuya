...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        dataTransferKeyNoticeViewController = [DataTransferKeyNoticeViewController new];
        dataTransferKeyNoticeViewController.delegate = self;
...
-(void) hideDataTakeInViewDownload:(BOOL)readBool{
    [dataTakeInViewController willMoveToParentViewController:nil];
    [dataTakeInViewController.view removeFromSuperview];
    [dataTakeInViewController removeFromParentViewController];
    //次画面を表示する
    [self dispNextView];
    
}

//ダウンロードページを非表示にするデリゲード
-(void) hideDataTakeInView:(UIViewController *) _dataTakeInViewController{
    ...
    //「機種変更キー」ページを表示
    [self movedatatransferKeyNotice];
}

//「機種変更キー」画面表示デリゲード
-(void)movedatatransferKeyNotice{
    [self addChildViewController:dataTransferKeyNoticeViewController];
    [self.view addSubview:dataTransferKeyNoticeViewController.view];
    [dataTransferKeyNoticeViewController didMoveToParentViewController:self];
